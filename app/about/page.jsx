    ...
    <section >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-start justify-center gap-4 my-10 px-4 mb-10">
          <div className="mb-10">
            <h1 className=" text-center text-2xl font-bold tracking-widest font-nav my-4 md:text-left md:text-4xl">
              About Us
            </h1>
            <p className="p-2 tracking-wider text-justify text-black">
          ...
          <div>
              ...
              <ul className="list-disc px-6">
                <li className="p-2 tracking-wider text-justify text-black">
