  ...
  return (
    <section >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-start justify-center gap-4 my-20 px-4">
          ...
          <Button 
            classes=  ' mt-6 w-[250px] font-nav border-solid border-2 border-black rounded-full px-6 py-2 text-md md:text-xl hover:bg-black hover:text-white'
            link = '#roles'
            text = 'View Our Roles'
          />
        </div>
        <div className="grid grid-cols-1 items-center justify-between px-4 py-2 space-y-6 md:space-x-8 lg:grid-cols-2">
          ...
          />
          <div>
           <p className="text-md font-nav md:text-lg">
        ...
        <h1 className="text-2xl text-center font-bold font-sans tracking-wide md:text-4xl lg:text-6xl" id="roles">Our Roles</h1>
        <div className="my-6">
          {OPENINGS.map((name) => (
            <Link href='#' >
