    ...
    <section className="md:h-[500px]">
        <div className="container-xl lg:container m-auto">
            <div className="grid grid-cols-1 items-center justify-around gap-8 p-8 mt-8 md:grid-cols-2" >
                <div className="px-4 py-6 flex flex-col items-center justify-center text-black md:block">
                    ...
                    <Button 
                        classes = 'text-white bg-black text-sm tracking-widest px-6 py-2 border border-white rounded-full mt-4 transition duration-500 ease-in-out hover:scale-75 md:w-[300px] md:py-4 md:text-lg'
                        link = '/about'
                        text = 'Read More'
                    />
                </div>
